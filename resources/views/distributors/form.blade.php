<div class="form-group row {{ $errors->has('name') ? 'is-validated' : ''}}">
    ...
    <div class="input-group-prepend">
        ...
        <input class="form-control" name="name" type="text" id="name" value="{{ isset($distributor->name) ? $distributor->name : ''}}" required>
</div>
...
<textarea class="form-control form-control-sm" rows="3" name="address" type="textarea" id="address" required>{{ isset($distributor->address) ? $distributor->address : ''}}</textarea>
...
<div class="form-group row {{ $errors->has('contact_number') ? 'is-validated' : ''}}">
    ...
    <div class="input-group-prepend">
        ...
        <input class="form-control" name="contact_number" type="text" id="contact_number" value="{{ isset($distributor->contact_number) ? $distributor->contact_number : ''}}" required>
</div>
...
<div class="form-group row {{ $errors->has('email') ? 'is-validated' : ''}}">
    ...
    <div class="input-group-prepend">
        ...
        <input class="form-control" name="email" type="text" id="email" value="{{ isset($distributor->email) ? $distributor->email : ''}}">
</div>
...
<div class="form-group row {{ $errors->has('docs_pdf') ? 'is-validated' : ''}}">
    ...
    <div class="input-group-prepend">
        ...
        <input class="form-control" name="docs_pdf" type="file" id="docs_pdf" value="{{ isset($distributor->docs_pdf) ? $distributor->docs_pdf : ''}}">
</div>
...
<div class="form-group row {{ $errors->has('credit_limit') ? 'is-validated' : ''}}">
    ...
    <div class="input-group-prepend">
        ...
        <input class="form-control" name="credit_limit" type="number" min="0" step="0.01" id="credit_limit" value="{{ isset($distributor->credit_limit) ? $distributor->credit_limit : ''}}" required>
</div>
...
<div class="form-group row {{ $errors->has('opening') ? 'is-validated' : ''}}">
    ...
    <div class="input-group-prepend">
        ...
        <input class="form-control" name="opening" type="number" min="0" step="0.01" id="opening" value="{{ isset($distributor->opening) ? $distributor->opening : ''}}" required>
</div>
