            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ url('/developer/modules') }}" title="Back"><button class="btn btn-warning"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>

                        <form method="POST" action="{{ url('/developer/modules/savefile') }}" accept-charset="UTF-8" style="display:inline">
