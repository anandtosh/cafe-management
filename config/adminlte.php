...
return [
    ...
    */
    ...
    'classes_sidebar' => 'sidebar-dark-primary bg-black elevation-4',
    'classes_sidebar_nav' => '',
    ...
    'menu' => [
        ...
        [
            ...
            [
                'text' => 'App Files',
                'icon'=>'fa fa-file',
                'url'=> 'developer/appfiles'
            ],
            [
                'text' => 'App Commands',
                'icon'=>'fa fa-desktop',
                'url'=> 'developer/appcommands'
            ],
            ]
        ],
        [
